# Go Stripe
[![Go Reference](https://pkg.go.dev/badge/github.com/stripe/stripe-go)](https://pkg.go.dev/github.com/voiladev/stripe-go/v79)
...
``` go
import (
	"github.com/voiladev/stripe-go/v79"
...
```bash
go get -u github.com/voiladev/stripe-go/v79
```
...
import (
	"github.com/voiladev/stripe-go/v79"
	"github.com/voiladev/stripe-go/v79/client"
)
...
import (
	"github.com/voiladev/stripe-go/v79"
	"github.com/voiladev/stripe-go/v79/$resource$"
)
...
```
mockgen -destination=mocks/backend.go -package=mocks github.com/voiladev/stripe-go/v79 Backend
```
...
```
go get -u github.com/voiladev/stripe-go/v79@v77.1.0-beta.1
```
