...
import (
	...
	"github.com/voiladev/stripe-go/v79/account"
	"github.com/voiladev/stripe-go/v79/accountlink"
	"github.com/voiladev/stripe-go/v79/accountsession"
	"github.com/voiladev/stripe-go/v79/applepaydomain"
	"github.com/voiladev/stripe-go/v79/applicationfee"
	appssecret "github.com/voiladev/stripe-go/v79/apps/secret"
	"github.com/voiladev/stripe-go/v79/balance"
	"github.com/voiladev/stripe-go/v79/balancetransaction"
	"github.com/voiladev/stripe-go/v79/bankaccount"
	billingmeter "github.com/voiladev/stripe-go/v79/billing/meter"
	billingmeterevent "github.com/voiladev/stripe-go/v79/billing/meterevent"
	billingmetereventadjustment "github.com/voiladev/stripe-go/v79/billing/metereventadjustment"
	billingmetereventsummary "github.com/voiladev/stripe-go/v79/billing/metereventsummary"
	billingportalconfiguration "github.com/voiladev/stripe-go/v79/billingportal/configuration"
	billingportalsession "github.com/voiladev/stripe-go/v79/billingportal/session"
	"github.com/voiladev/stripe-go/v79/capability"
	"github.com/voiladev/stripe-go/v79/card"
	"github.com/voiladev/stripe-go/v79/cashbalance"
	"github.com/voiladev/stripe-go/v79/charge"
	checkoutsession "github.com/voiladev/stripe-go/v79/checkout/session"
	climateorder "github.com/voiladev/stripe-go/v79/climate/order"
	climateproduct "github.com/voiladev/stripe-go/v79/climate/product"
	climatesupplier "github.com/voiladev/stripe-go/v79/climate/supplier"
	"github.com/voiladev/stripe-go/v79/confirmationtoken"
	"github.com/voiladev/stripe-go/v79/countryspec"
	"github.com/voiladev/stripe-go/v79/coupon"
	"github.com/voiladev/stripe-go/v79/creditnote"
	"github.com/voiladev/stripe-go/v79/customer"
	"github.com/voiladev/stripe-go/v79/customerbalancetransaction"
	"github.com/voiladev/stripe-go/v79/customercashbalancetransaction"
	"github.com/voiladev/stripe-go/v79/customersession"
	"github.com/voiladev/stripe-go/v79/dispute"
	entitlementsactiveentitlement "github.com/voiladev/stripe-go/v79/entitlements/activeentitlement"
	entitlementsfeature "github.com/voiladev/stripe-go/v79/entitlements/feature"
	"github.com/voiladev/stripe-go/v79/ephemeralkey"
	"github.com/voiladev/stripe-go/v79/event"
	"github.com/voiladev/stripe-go/v79/feerefund"
	"github.com/voiladev/stripe-go/v79/file"
	"github.com/voiladev/stripe-go/v79/filelink"
	financialconnectionsaccount "github.com/voiladev/stripe-go/v79/financialconnections/account"
	financialconnectionssession "github.com/voiladev/stripe-go/v79/financialconnections/session"
	financialconnectionstransaction "github.com/voiladev/stripe-go/v79/financialconnections/transaction"
	forwardingrequest "github.com/voiladev/stripe-go/v79/forwarding/request"
	identityverificationreport "github.com/voiladev/stripe-go/v79/identity/verificationreport"
	identityverificationsession "github.com/voiladev/stripe-go/v79/identity/verificationsession"
	"github.com/voiladev/stripe-go/v79/invoice"
	"github.com/voiladev/stripe-go/v79/invoiceitem"
	"github.com/voiladev/stripe-go/v79/invoicelineitem"
	issuingauthorization "github.com/voiladev/stripe-go/v79/issuing/authorization"
	issuingcard "github.com/voiladev/stripe-go/v79/issuing/card"
	issuingcardholder "github.com/voiladev/stripe-go/v79/issuing/cardholder"
	issuingdispute "github.com/voiladev/stripe-go/v79/issuing/dispute"
	issuingpersonalizationdesign "github.com/voiladev/stripe-go/v79/issuing/personalizationdesign"
	issuingphysicalbundle "github.com/voiladev/stripe-go/v79/issuing/physicalbundle"
	issuingtoken "github.com/voiladev/stripe-go/v79/issuing/token"
	issuingtransaction "github.com/voiladev/stripe-go/v79/issuing/transaction"
	"github.com/voiladev/stripe-go/v79/loginlink"
	"github.com/voiladev/stripe-go/v79/mandate"
	"github.com/voiladev/stripe-go/v79/oauth"
	"github.com/voiladev/stripe-go/v79/paymentintent"
	"github.com/voiladev/stripe-go/v79/paymentlink"
	"github.com/voiladev/stripe-go/v79/paymentmethod"
	"github.com/voiladev/stripe-go/v79/paymentmethodconfiguration"
	"github.com/voiladev/stripe-go/v79/paymentmethoddomain"
	"github.com/voiladev/stripe-go/v79/paymentsource"
	"github.com/voiladev/stripe-go/v79/payout"
	"github.com/voiladev/stripe-go/v79/person"
	"github.com/voiladev/stripe-go/v79/plan"
	"github.com/voiladev/stripe-go/v79/price"
	"github.com/voiladev/stripe-go/v79/product"
	"github.com/voiladev/stripe-go/v79/productfeature"
	"github.com/voiladev/stripe-go/v79/promotioncode"
	"github.com/voiladev/stripe-go/v79/quote"
	radarearlyfraudwarning "github.com/voiladev/stripe-go/v79/radar/earlyfraudwarning"
	radarvaluelist "github.com/voiladev/stripe-go/v79/radar/valuelist"
	radarvaluelistitem "github.com/voiladev/stripe-go/v79/radar/valuelistitem"
	"github.com/voiladev/stripe-go/v79/refund"
	reportingreportrun "github.com/voiladev/stripe-go/v79/reporting/reportrun"
	reportingreporttype "github.com/voiladev/stripe-go/v79/reporting/reporttype"
	"github.com/voiladev/stripe-go/v79/review"
	"github.com/voiladev/stripe-go/v79/setupattempt"
	"github.com/voiladev/stripe-go/v79/setupintent"
	"github.com/voiladev/stripe-go/v79/shippingrate"
	sigmascheduledqueryrun "github.com/voiladev/stripe-go/v79/sigma/scheduledqueryrun"
	"github.com/voiladev/stripe-go/v79/source"
	"github.com/voiladev/stripe-go/v79/sourcetransaction"
	"github.com/voiladev/stripe-go/v79/subscription"
	"github.com/voiladev/stripe-go/v79/subscriptionitem"
	"github.com/voiladev/stripe-go/v79/subscriptionschedule"
	taxcalculation "github.com/voiladev/stripe-go/v79/tax/calculation"
	taxregistration "github.com/voiladev/stripe-go/v79/tax/registration"
	taxsettings "github.com/voiladev/stripe-go/v79/tax/settings"
	taxtransaction "github.com/voiladev/stripe-go/v79/tax/transaction"
	"github.com/voiladev/stripe-go/v79/taxcode"
	"github.com/voiladev/stripe-go/v79/taxid"
	"github.com/voiladev/stripe-go/v79/taxrate"
	terminalconfiguration "github.com/voiladev/stripe-go/v79/terminal/configuration"
	terminalconnectiontoken "github.com/voiladev/stripe-go/v79/terminal/connectiontoken"
	terminallocation "github.com/voiladev/stripe-go/v79/terminal/location"
	terminalreader "github.com/voiladev/stripe-go/v79/terminal/reader"
	testhelpersconfirmationtoken "github.com/voiladev/stripe-go/v79/testhelpers/confirmationtoken"
	testhelperscustomer "github.com/voiladev/stripe-go/v79/testhelpers/customer"
	testhelpersissuingauthorization "github.com/voiladev/stripe-go/v79/testhelpers/issuing/authorization"
	testhelpersissuingcard "github.com/voiladev/stripe-go/v79/testhelpers/issuing/card"
	testhelpersissuingpersonalizationdesign "github.com/voiladev/stripe-go/v79/testhelpers/issuing/personalizationdesign"
	testhelpersissuingtransaction "github.com/voiladev/stripe-go/v79/testhelpers/issuing/transaction"
	testhelpersrefund "github.com/voiladev/stripe-go/v79/testhelpers/refund"
	testhelpersterminalreader "github.com/voiladev/stripe-go/v79/testhelpers/terminal/reader"
	testhelperstestclock "github.com/voiladev/stripe-go/v79/testhelpers/testclock"
	testhelperstreasuryinboundtransfer "github.com/voiladev/stripe-go/v79/testhelpers/treasury/inboundtransfer"
	testhelperstreasuryoutboundpayment "github.com/voiladev/stripe-go/v79/testhelpers/treasury/outboundpayment"
	testhelperstreasuryoutboundtransfer "github.com/voiladev/stripe-go/v79/testhelpers/treasury/outboundtransfer"
	testhelperstreasuryreceivedcredit "github.com/voiladev/stripe-go/v79/testhelpers/treasury/receivedcredit"
	testhelperstreasuryreceiveddebit "github.com/voiladev/stripe-go/v79/testhelpers/treasury/receiveddebit"
	"github.com/voiladev/stripe-go/v79/token"
	"github.com/voiladev/stripe-go/v79/topup"
	"github.com/voiladev/stripe-go/v79/transfer"
	"github.com/voiladev/stripe-go/v79/transferreversal"
	treasurycreditreversal "github.com/voiladev/stripe-go/v79/treasury/creditreversal"
	treasurydebitreversal "github.com/voiladev/stripe-go/v79/treasury/debitreversal"
	treasuryfinancialaccount "github.com/voiladev/stripe-go/v79/treasury/financialaccount"
	treasuryinboundtransfer "github.com/voiladev/stripe-go/v79/treasury/inboundtransfer"
	treasuryoutboundpayment "github.com/voiladev/stripe-go/v79/treasury/outboundpayment"
	treasuryoutboundtransfer "github.com/voiladev/stripe-go/v79/treasury/outboundtransfer"
	treasuryreceivedcredit "github.com/voiladev/stripe-go/v79/treasury/receivedcredit"
	treasuryreceiveddebit "github.com/voiladev/stripe-go/v79/treasury/receiveddebit"
	treasurytransaction "github.com/voiladev/stripe-go/v79/treasury/transaction"
	treasurytransactionentry "github.com/voiladev/stripe-go/v79/treasury/transactionentry"
	"github.com/voiladev/stripe-go/v79/usagerecord"
	"github.com/voiladev/stripe-go/v79/usagerecordsummary"
	"github.com/voiladev/stripe-go/v79/webhookendpoint"
)
